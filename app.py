...
# ==========================================
# 1. FIXED DARK THEME & STYLING ADJUSTMENTS
# ==========================================
st.set_page_config(
...
# Custom CSS - Disesuaikan penuh dengan tema gelap (Dark Mode) seperti di tangkapan layar Anda
st.markdown("""
<style>
    @import url('https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght=400;500;600;700&display=swap');
    
    /* Base Background App & Main Content (Dark Theme) */
    ...
    /* Metrics Layout style & Perbaikan Teks Terang di Latar Gelap */
    .metric-box {
    ...
    .metric-box-delta { font-size: 14px; color: #34d399 !important; font-weight: 600; margin-top: 2px; }
    
    /* Kotak Info/Alert yang Selaras dengan Dark Theme (Tanpa Bug Elemen Kosong) */
    .info-box-warn {
    ...
    .info-box-warn h4 { color: #fdba74 !important; margin-top: 0px !important; }
    ...
    .info-box-success h4 { color: #6ee7b7 !important; margin-top: 0px !important; }
    
    /* Global Text Override untuk Streamlit Element */
...
# Fungsi Chart styling untuk Dark Mode agar menyatu dengan latar belakang aplikasi
def apply_dark_theme_layout(fig):
    fig.update_layout(
        ...
        legend_font_color="#f3f4f6"
    )
    fig.update_xaxes(gridcolor='#1f2937', title_font_color="#f3f4f6", tickfont_color="#f3f4f6")
    fig.update_yaxes(gridcolor='#1f2937', title_font_color="#f3f4f6", tickfont_color="#f3f4f6")
    return fig

# ==========================================
# PERCABANGAN HALAMAN (NAVIGASI)
# ==========================================
...
# MODUL 5: BATAS KEBIJAKAN TRADE-OFF
    ...
    # Grafik Batas Trade-off Dinamis (Dark Theme)
    ...
    fig_tradeoff = apply_dark_theme_layout(fig_tradeoff)
    ...
    with col_r:
        st.markdown("""
        <div class="info-box-warn" style="border-left-color: #3b82f6 !important; background-color: #1e3a8a !important; color: #dbeafe !important;">
    ...
    st.markdown("<br><hr style='border-color: #374151;'><center style='color: #9ca3af; font-size: 12px;'>Sistem Simulasi Kebijakan disusun oleh: PBL Kelompok 2</center>", unsafe_allow_html=True)
...
# MODUL 6: SLIDER SIMULASI FINANSIAL
    ...
    st.markdown("<br><hr style='border-color: #374151;'><center style='color: #9ca3af; font-size: 12px;'>Sistem Simulasi Finansial disusun oleh: PBL Kelompok 2</center>", unsafe_allow_html=True)
